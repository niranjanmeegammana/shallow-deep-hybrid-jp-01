...
#-------------------------
xmodel="shadeep_hyb_concat_401" # additional processing layers
# Define the features
...
weight_shallow = 1.0  # Weight for shallow model prediction
weight_deep = 1.0  # Weight for deep model prediction
weighted_pred_shallow = pred_shallow * weight_shallow
weighted_pred_deep = pred_deep * weight_deep

# Concatenate the predictions
z = tf.keras.layers.Concatenate()([weighted_pred_shallow, weighted_pred_deep])
